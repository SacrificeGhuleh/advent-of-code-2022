...
struct ElfPair
{
    ElfPair(const std::pair<size_t, size_t> &e1, const std::pair<size_t, size_t> &e2) : e1{e1}, e2{e2}, subset{isSubset(e1, e2)}, overlap{isOverlap(e1, e2)} {}
    ...
    static bool isSubset(const std::pair<size_t, size_t> &e1, const std::pair<size_t, size_t> &e2, bool recurse = true)
    {
    ...
    static bool isOverlap(const std::pair<size_t, size_t> &e1, const std::pair<size_t, size_t> &e2, bool recurse = true)
    {
...
void test()
{
    ...
    {
        ElfPair elfPair({std::stoi(matches[1].str()), std::stoi(matches[2].str())}, {std::stoi(matches[3].str()), std::stoi(matches[4].str())});
